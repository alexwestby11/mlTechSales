                     ...
                     for (var j = 0; j < y; ++j) {//rows
                         ...
                         for (var k = 0; k < x; ++k) {//col
                             ...
                             stringValue += "<td>" +
                                 ...
                                 "<img tag = '"+index+"' id = 'rec"+index+"' class = \" img-fluid btn rounded X creamColor btn-primary shadow\" src = \"images/Apple1.jpg\" onclick='reply_ProPage(this.id)'>"+
                                 "</div>";
                             ++index;
                         }
                         stringValue += "</div> ";
...
function setSimImages(x){
     ...
     for(var i = 0; i < x; ++i){
//console.log(document.getElementById("rec" + i.toString())) = recArray[i].img_src;
         document.getElementById("sim" + i.toString()).style.backgroundImage = simArray[i].img_src;
            }
}
